<!-- Sidebar menu-->
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media();?>/images/avatar.png" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Admin Greise</p>
          <p class="app-sidebar__user-designation">Admnistrador</p>
        </div>
      </div>
      <ul class="app-menu">
        <li><a class="app-menu__item" href="<?= base_url()?>/Paginablanco"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Principal</span></a></li>
        ...
        <li>
          <a class="app-menu__item" href="<?= base_url()?>/categoria">
        ...
        <li>
          <a class="app-menu__item" href="<?= base_url()?>/cerrarsesion">
